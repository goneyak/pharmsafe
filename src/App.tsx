...
const MEDICATIONS: Medication[] = [
  ...
  },
  {
    ...
    pregnancySafety: 'avoid',
    pregnancyNote: '세로토닌 수용체 길항제. 최후의 수단으로만 고려. 임신 초기(1삼분기) 사용 시 구순구개열 및 심장 기형 위험이 소폭 증가한다는 보고가 있습니다.',
    lactationSafety: 'caution',
  ...
  },
  {
    ...
    pregnancySafety: 'avoid',
    pregnancyNote: '자궁 수축 유발 가능성 및 증상 차폐 우려로 고혈압 치료 목적으로는 임신 중 사용을 권장하지 않습니다.',
    lactationSafety: 'safe',
